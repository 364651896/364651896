...
while true
do
	echo "1. IPV4优选 (Telegram, TLS)"
	echo "2. IPV6优选 (Telegram, TLS)"
	echo "3. 单IP测速 (Telegram, TLS)"
	echo "7. 清空缓存"
	echo "8. 更新数据"
	echo -e "0. 退出\n"
